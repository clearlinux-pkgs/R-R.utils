...
Source0  : https://cran.r-project.org/src/contrib/R.utils_2.8.0.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1550337941
...
R CMD check --no-manual --no-examples --no-codoc -l %{buildroot}/usr/lib64/R/library R.utils|| : 
cp ~/.stash/* %{buildroot}/usr/lib64/R/library/*/libs/ || :
